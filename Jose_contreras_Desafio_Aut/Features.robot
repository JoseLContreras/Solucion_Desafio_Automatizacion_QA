...
Resumen Compra
    ...
    Capture Page Screenshot   ${URLscreenshot}/carrito.png
...
Crear Cuenta
    ...
    Capture Page Screenshot  ${URLscreenshot}/crearcuenta.png
...
Confirmar Dirección
    ...
    Scroll Element Into View    xpath=//*[@id="newsletter_block_left"]/h4
    Capture Page Screenshot   ${URLscreenshot}/direccion.png
...
Shipping
    ...
    Scroll Element Into View    xpath=//*[@id="newsletter_block_left"]/h4
    Capture Page Screenshot   ${URLscreenshot}/shipping.png
...
Pago y confirmación de orden de compra
    ...
    Scroll Element Into View    xpath=//*[@id="newsletter_block_left"]/h4
    Capture Page Screenshot   ${URLscreenshot}/orden.png
...
Visitar historia de órdenes y descargar PDF
    ...
    Scroll Element Into View    xpath=//*[@id="newsletter_block_left"]/h4
    Capture Page Screenshot   ${URLscreenshot}/On_back_order.png
